...
void fft(j_complex_t *X, int M)
         /* X is an array of N = 2**M j_complex_t points. */
	   /* M = log2(N), N is the number of points */
  {
  j_complex_t temp1;          /* temporary storage j_complex_t variable */
  j_complex_t W;              /* e**(-j 2 pi/ N)                    */
  j_complex_t U;              /* Twiddle factor W**k                */
